...
import parts from "../assets/img/projects/perts.png";
...
import gadget from "../assets/img/projects/gadget.png";
import medicine from "../assets/img/projects/309316911_1294765374394849_1942865363419393917_n.jpg";
import money from "../assets/img/projects/money.png";
  ...
  return (
    <div className=" container mx-auto grid grid-cols-1 md:grid-cols-3 gap-5 mt-14 gap-y-10">
      <div class="card w-96 shadow-xl transition ease-in-out delay-150 bg-black hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300">
        <div class="card w-96 shadow-xl transition ease-in-out delay-150 bg-black hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300">
          ...
          <div class="card-body items-center text-center">
            <h2 class="card-title title">Parts Manufacturer System</h2>
            <div className="mt-3">
              <button type="button"
                class=" w-18 h-10 text-white btn btn-outline btn-secondary">
                <a
                  href="https://perts-store.web.app/"
                  target="_blank"
              ...
              <div className="mt-3">
                ...
                >
                  ...
                  <a
                    href="https://github.com/parvezislam45/pertsstore-client"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="mt-3">
              ...
              >
                ...
                <a
                  href="https://github.com/parvezislam45/pertsStore-server"
                  target="_blank"
                  rel="noopener noreferrer"
                >
      ...
      <div class="mt-10 max-w-sm mx-auto">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title title">Bike WereHouse Management</h2>
          <div className="mt-3">
            <button class=" w-18 h-10 text-white btn btn-outline btn-secondary">
              <a
      ...
      <div class="mt-10 max-w-sm mx-auto">
          <div class="relative group">
            <figure class="px-10 pt-10">
              <img src={gadget} alt="David" class="rounded-xl" />
            </figure>
            <div class="flex justify-center items-center opacity-0 bg-gradient-to-t from-black via-black to-opacity-100 group-hover:opacity-100 absolute top-0 left-0 h-full w-full"></div>
            <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center opacity-0 hover:opacity-100">
              <div class="flex-row text-center">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title title">Gadget Mania</h2>
          <div className="mt-3">
            <button class=" w-18 h-10 text-white btn btn-outline btn-secondary">
              <a
                href="https://geargagdet.web.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Live Site
          ...
          <div className="mt-3">
            ...
            >
              ...
              <a
                href="https://github.com/parvezislam45/gadget-gear-server"
                target="_blank"
                rel="noopener noreferrer"
              >
                Git Hub Server Site Code
          ...
          <div className="mt-3">
            ...
            >
              ...
              <a
                href="https://github.com/parvezislam45/gadgetmania"
                target="_blank"
                rel="noopener noreferrer"
              >
                Git Hub Client Site Code
        ...
        <div class="card-body items-center text-center">
          ...
          <div className="mt-3">
            <button type="button"
              class="w-18 h-10 text-white btn btn-outline btn-secondary">
              <a
                href="https://parvez-blackview-phonemania.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Live Site Link
      ...
      <div class="card w-96 shadow-xl transition ease-in-out delay-150 bg-black hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300">
        <div class="mt-10 max-w-sm mx-auto">
          <div class="relative group">
            <figure class="px-10 pt-10">
              <img src={medicine} alt="Shoes" class="rounded-xl" />
            </figure>
            <div class="flex justify-center items-center opacity-0 bg-gradient-to-t from-black via-black to-opacity-100 group-hover:opacity-100 absolute top-0 left-0 h-full w-full"></div>
            <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center opacity-0 hover:opacity-100">
              <div class="flex-row text-center">
                ...
                <h6 class="text-teal-300 text-xs">Use React Native</h6>
                <h6 class="text-teal-300 text-xs">Use Dynamic Search Bar</h6>
                <h6 class="text-teal-300 text-xs">Medicine Details</h6>
              </div>
            </div>
          </div>
        </div>
        <div class="card-body items-center text-center">
          <h2 class="card-title title">React Native Mobile App</h2>
          <div className="mt-3">
            <button
              type="button"
              class="text-white btn btn-outline btn-secondary"
            >
              ...
              <a
                href="https://github.com/parvezislam45/Drug-App"
                target="_blank"
                rel="noopener noreferrer"
              >
                Git Hub Client Site Code
      ...
      <div class="card w-96 shadow-xl transition ease-in-out delay-150 bg-black hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300">
        <div class="mt-10 max-w-sm mx-auto">
          <div class="relative group">
            <figure class="px-10 pt-10">
              <img src={money} alt="Shoes" class="rounded-xl" />
            </figure>
            <div class="flex justify-center items-center opacity-0 bg-gradient-to-t from-black via-black to-opacity-100 group-hover:opacity-100 absolute top-0 left-0 h-full w-full"></div>
            <div class="absolute top-0 left-0 w-full h-full flex justify-center items-center opacity-0 hover:opacity-100">
              <div class="flex-row text-center">
                ...
                <h6 class="text-xs font-light text-teal-300 ">Use Java Script ES-6</h6>
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title title">Income Expense Calculation</h2>
          <div className="mt-3">
            <button type="button"
              class="w-18 h-10 text-white btn btn-outline btn-secondary">
              <a
                href="https://parvez-income-expense-calculation.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Live Site Link
      ...
      <div class="card w-96 shadow-xl transition ease-in-out delay-150 bg-black hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title title">Vanou's Convention Hotel</h2>
          <div className="mt-3">
            <button type="button"
              class="w-18 h-10 text-white btn btn-outline btn-secondary">
              <a
                href="https://vanos-convension-hotel.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Live Site Link
